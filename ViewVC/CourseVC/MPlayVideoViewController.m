...
- (void)viewDidLoad
{
    ...
    self.menuView = [[MMenuView alloc]initWithFrame:menuR
                                    ...
                                    itemSelectColor:[UIColor colorWithHexString:@"#DC848D" alpha:1]
                                      tableDelegate:self
...
{
    if (tableView.tag-kSubTableViewTag == 3)
    {
        return 3;
    }
    return 1;
...
-(UITableViewCell *)mInitChapterCellWithTableView:(UITableView *)tableView indexPath:(NSIndexPath *)indexPath
{
    ...
    MChapterCell *cell = [tableView dequeueReusableCellWithIdentifier:Identifier];
    if (!cell)
    {
        cell = [[NSBundle mainBundle]loadNibNamed:@"MChapterCell" owner:nil options:nil].firstObject;
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
    }
    return cell;
}
...
-(UITableViewCell *)mInitDiscussNotesCellWithTableView:(UITableView *)tableView indexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *array = [datas objectAtIndex:currentIndex];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (tag == 3)
    {
        ...
        UIView *line = [[UIView alloc]initWithFrame:CGRectMake(0, 10, 5, 24)];
        line.backgroundColor = [UIColor redColor];
        [headerView addSubview:line];
        
        UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 0, tableView.frame.size.width-15, 44)];
        titleLabel.text = [NSString stringWithFormat:@"第%d章",section+1];
